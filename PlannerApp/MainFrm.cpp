...
// OnGetMinMaxInfo()
// This function restricts the minimum size of the main window object
// to help maintain a decent viewing experience at all times.
void CMainFrame::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
	// the minimum client rectangle 
