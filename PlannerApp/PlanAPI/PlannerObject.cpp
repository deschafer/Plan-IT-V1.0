...
CPlannerObject::CPlannerObject(int begYear, int endYear, CString Name) : m_CurrentYear(nullptr)
{
	// Local vars
	int YearDate = 0;
	...
	// Getting the date of this year to compare if 
	// current year is today's year
	...
	for (int i = 0; i < m_YearCount; i++)
	{
		...
		CYear * object = new CYear(begYear + i);
